...
export function Process() {
  const { t } = useLang();
  return (
    <section id="process" className="relative px-4 py-10 sm:px-6 sm:py-12 md:py-16">
        ...
        <ol className="space-y-2">
          {t.process.steps.map((s, i) => (
            <motion.li
              ...
              className="group grid grid-cols-12 items-baseline gap-3 border-t border-aura-ink/10 py-6 sm:gap-4 sm:py-7 md:gap-8 md:py-9"
            >
              <span
